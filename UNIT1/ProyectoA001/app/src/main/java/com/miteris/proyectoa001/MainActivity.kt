package com.miteris.proyectoa001
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val et1       =   findViewById<EditText>(R.id.txtN1)
        val et2       =   findViewById<EditText>(R.id.txtN2)
        val tv1       =   findViewById<TextView>(R.id.tvRes)
        val btnSuma   =   findViewById<Button>(R.id.btnSuma)
        val btnResta  =   findViewById<Button>(R.id.btnResta)
        val btnDivi   =   findViewById<Button>(R.id.btnDivi)
